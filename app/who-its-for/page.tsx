...
const B = ({ ch }: { ch: React.ReactNode }) => (
  <p style={s({ fontFamily: E.sans, fontSize: 18, lineHeight: 1.85, color: E.body, marginBottom: 18 })}>{ch}</p>
)
...
export default function WhoItsFor() {
  return (
    <main style={s({ minHeight: "100vh", background: E.bg, color: E.text, fontFamily: E.sans })}>
      ...
      {/* HERO */}
      <div style={s({ padding: "47px 44px 47px", borderBottom: `1px solid ${E.bdr}`, maxWidth: 820 })}>
        <p style={s({ fontFamily: E.mono, fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase" as const, color: E.muted, marginBottom: 16 })}>Who It&apos;s For</p>
        <h1 style={s({ fontFamily: E.sans, fontSize: "clamp(47px, 6vw, 76px)", fontWeight: 700, lineHeight: 1.05, color: E.text, letterSpacing: "-0.03em", marginBottom: 28 })}>
          The investor this was
          <em style={s({ fontStyle: "italic", fontFamily: E.serif, fontWeight: 400, color: E.brick, fontSize: "clamp(47px, 6vw, 76px)", letterSpacing: "-0.01em" })}> built for.</em>
        </h1>
        <p style={s({ fontFamily: E.sans, fontSize: 18, lineHeight: 1.8, color: E.body, maxWidth: 600 })}>
      ...
      <div style={s({ display: "grid", gridTemplateColumns: "1fr 360px", borderBottom: `1px solid ${E.bdr}` })}>
        ...
        <div style={s({ borderRight: `1px solid ${E.bdr}` })}>
          ...
          {/* Block 1 */}
          <div style={s({ padding: "29px 44px", borderBottom: `1px solid ${E.bdr}` })}>
            ...
            <h2 style={s({ fontFamily: E.sans, fontSize: "18px", fontWeight: 700, lineHeight: 1.15, color: E.text, letterSpacing: "-0.02em", marginBottom: 20 })}>
            ...
            <div style={s({ borderLeft: `3px solid ${E.brick}`, padding: "16px 22px", margin: "28px 0", background: E.gatm })}>
              <p style={s({ fontFamily: E.serif, fontStyle: "italic", fontSize: 18, lineHeight: 1.75, color: E.text })}>
          ...
          {/* Block 2 */}
          <div style={s({ padding: "29px 44px", borderBottom: `1px solid ${E.bdr}`, background: E.gatm })}>
            <p style={s({ fontFamily: E.mono, fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase" as const, color: E.muted, marginBottom: 14 })}>02 — The investor</p>
            <h2 style={s({ fontFamily: E.sans, fontSize: "18px", fontWeight: 700, lineHeight: 1.15, color: E.text, letterSpacing: "-0.02em", marginBottom: 20 })}>
          ...
          <div style={s({ padding: "29px 44px" })}>
            ...
            <div style={s({ border: `1px solid ${E.bdr}`, background: E.bg2, padding: "24px", marginTop: 28 })}>
              <p style={s({ fontFamily: E.mono, fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: E.muted, marginBottom: 16 })}>What this means in practice</p>
              <div style={s({ display: "flex", flexDirection: "column" })}>
                {[
                  ...
                  <div key={principle} style={s({ display: "grid", gridTemplateColumns: "180px 1fr", gap: 16, padding: "14px 0", borderBottom: i < 4 ? `1px solid ${E.bdr}` : "none" })}>
                    <div style={s({ fontFamily: E.sans, fontSize: 18, fontWeight: 700, color: E.text })}>{principle}</div>
                    <div style={s({ fontFamily: E.sans, fontSize: 18, lineHeight: 1.65, color: E.body })}>{reason}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* Sidebar */}
        <div style={s({ padding: "29px 29px", background: E.bg2 })}>

          <div style={s({ marginBottom: 32, paddingBottom: 32, borderBottom: `1px solid ${E.bdr}` })}>
            <p style={s({ fontFamily: E.mono, fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: E.muted, marginBottom: 14 })}>What this is not</p>
            <p style={s({ fontFamily: E.sans, fontSize: 18, lineHeight: 1.7, color: E.text, fontWeight: 700, marginBottom: 14 })}>
            ...
            {[
              ...
              <div key={item} style={s({ display: "flex", gap: 10, alignItems: "baseline", padding: "9px 0", borderBottom: i < 4 ? `1px solid ${E.bdr}` : "none" })}>
                ...
                <span style={s({ fontFamily: E.sans, fontSize: 18, color: E.body })}>{item}</span>
              </div>
            ))}
          </div>

          <div style={s({ marginBottom: 32, paddingBottom: 32, borderBottom: `1px solid ${E.bdr}` })}>
            <p style={s({ fontFamily: E.mono, fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: E.muted, marginBottom: 14 })}>The empirical record</p>
            <p style={s({ fontFamily: E.sans, fontSize: 18, lineHeight: 1.78, color: E.body, marginBottom: 16 })}>Validated across 289,737 observations · 17 years:</p>
            {[
              ...
              <div key={label} style={s({ display: "flex", justifyContent: "space-between", alignItems: "baseline", padding: "9px 0", borderBottom: `1px solid ${E.bdr}` })}>
                <span style={s({ fontFamily: E.sans, fontSize: 18, color: E.body })}>{label}</span>
                <div style={s({ textAlign: "right" as const })}>
                  <span style={s({ fontFamily: E.mono, fontSize: 18, fontWeight: 400, color: E.text })}>{val}</span>
          ...
          <div style={s({ border: `1px solid ${E.bdr}`, borderTop: `3px solid ${E.brick}`, background: E.bg, padding: "20px" })}>
            <p style={s({ fontFamily: E.mono, fontSize: 11, letterSpacing: "0.18em", textTransform: "uppercase" as const, color: E.muted, marginBottom: 12 })}>Foundational principle</p>
            <p style={s({ fontFamily: E.serif, fontStyle: "italic", fontSize: 18, lineHeight: 1.78, color: E.text, marginBottom: 12 })}>
            ...
            <p style={s({ fontFamily: E.mono, fontSize: 11, letterSpacing: "0.12em", color: E.muted })}>— The Capital Steward, founding principle</p>
          </div>
      ...
      {/* CTA */}
      <div style={s({ padding: "47px 44px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 40, borderBottom: `1px solid ${E.bdr}` })}>
